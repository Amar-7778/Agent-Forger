...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AgentForge — AI agent builder for teams" },
      { name: "description", content: "Build, schedule, and chat with your AI workforce — no code required." },
      { property: "og:title", content: "AgentForge" },
